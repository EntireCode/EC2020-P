...
namespace EC.Web.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new ApplicationUser { FirstName = Input.FirstName, LastName = Input.LastName, UserName = Input.Email, Email = Input.Email, AvatarURL = "/img/avatars/1.jpg" };
                ...
                if (result.Succeeded)
                {
                    ...
                    //comment below line of code to prevent newly registered users from being logged on automatically
