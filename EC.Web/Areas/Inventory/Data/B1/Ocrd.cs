...
namespace EC.Web.Areas.Inventory.Data.B1
{
    public partial class Ocrd
    {
        ...
        public decimal? UInsAmt { get; set; }
        public short? UUserSign2 { get; set; }
        public string UFedEx { get; set; }
        public string UUps { get; set; }
        public string UIncoTerm { get; set; }
        public string UIncoPoint { get; set; }
        public string UUserList { get; set; }
        public string UMgrList { get; set; }
        public DateTime? UCreateDate { get; set; }
        public string UUserSign1 { get; set; }
        public string UBoy23Qccs { get; set; }
        public string UBoy23Adprtcd { get; set; }
