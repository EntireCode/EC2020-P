...
namespace EC.Web.Areas.Inventory.Data.B1
{
    public partial class Oitm
    {
        ...
        public string UPhadesign { get; set; }
        public string UPhnydesign { get; set; }
        public string UPhtdesign { get; set; }
        public string UCoc { get; set; }
        public string UTariff { get; set; }
        public decimal? UGrossVolume { get; set; }
        public decimal? UBomcost { get; set; }
        public decimal? ULaborCost { get; set; }
        public decimal? UBaseline { get; set; }
        public DateTime? UCreateDate { get; set; }
        public string UUserSign { get; set; }
        public string UTracking1 { get; set; }
        public string UTracking2 { get; set; }
        public string UPhtBu { get; set; }
        public string UBuApp { get; set; }
        public string UTariffHn { get; set; }
