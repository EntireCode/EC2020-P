...
namespace EC.Web.Areas.Inventory.Data.B1
{
    public partial class Orin
    {
        ...
        public string USono { get; set; }
        public string USalesManager { get; set; }
        public string UAprefNo { get; set; }
        public decimal? USalesAmt { get; set; }
        public string UIvcivpno { get; set; }
        public DateTime? UIvcivpdate { get; set; }
        public string UTlno { get; set; }
        public short? UAgingDays { get; set; }
        public DateTime? UCreateDate { get; set; }
        public string URemarks2 { get; set; }
        public string UMemo1 { get; set; }
        public string UOrderFor { get; set; }
        public string UIncoTerm { get; set; }
        public string UIncoPoint { get; set; }
        public string UEcsDocFreight { get; set; }
        public string UItnNumber { get; set; }
    }
}
